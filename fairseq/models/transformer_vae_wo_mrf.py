...
class TransformerVAENoMRFModel(TransformerModel):
    @staticmethod
    def add_args(parser):
        """
...
@register_model_architecture("transformer_vae_wo_mrf", "transformer_vae_wo_mrf")
def base_architecture(args):
    transformer_base_architecture(args)


@register_model_architecture("transformer_vae_wo_mrf", "transformer_vae_wo_mrf_base")
...
@register_model_architecture("transformer_vae_wo_mrf", "transformer_vae_wo_mrf_tiny")
