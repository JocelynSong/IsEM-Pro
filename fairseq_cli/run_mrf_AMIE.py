...
train_dataset = ProteinDataset('../../datasets/{}.txt'.format(protein))
...
class MRF(nn.Module):
    ...
    def forward(self, x):
        ...
        loss = final_energy + single_reg + pair_reg
        return loss
...
for epoch in range(5):
    ...
    save_single_file = "./../datasets/{}/single.pt".format(protein)
    save_pair_file = "./../datasets/{}/pair.pt".format(protein)
